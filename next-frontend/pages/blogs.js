            ...
            <div className="bg-grey-50 my-12" id="blog">
                    ...
                    <div className="mx-auto grid w-full grid-cols-1 gap-6 pt-12 sm:w-3/4 lg:w-full lg:grid-cols-3 xl:gap-10">
                        ...
                        <div>
                            ...
                            <span
                            className="absolute right-0 bottom-0 mr-4 mb-4 block rounded-full border-2 bg-purple-700 border-purple-700 px-6 py-2 text-center font-body text-sm text-purple-200 font-bold uppercase  md:text-base cursor-pointer">Read
                            More</span>
                        </div>
